...
\tcbset{
  myboxstyle/.style={
    colback=orange!10,   % Couleur de fond
    colframe=orange!50,  % Couleur du cadre
    boxrule=0.8mm,     % Épaisseur du cadre
    left=10mm,          % Marge à gauche
    right=10mm,         % Marge à droite
    top=2mm,           % Marge en haut
    bottom=2mm,        % Marge en bas
  }
}
...
\input{parts/ZYGO_interface_principe.tex}
